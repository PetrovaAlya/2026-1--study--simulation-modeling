...
println("Detection time = $(round(Int, best[2])) days")
println("Death rate = $(best[3])")
println("Achieved values:")
println("Peak infection fraction: $(fitness[1])")
println("Death fraction: $(fitness[2])")
