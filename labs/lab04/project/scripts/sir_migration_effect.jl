...
for params in params_list
    ...
    println("Done migration_intensity = $(params[:migration_intensity]), seed = $(params[:seed])")
end
...
println("Results saved to data/migration_scan_all.csv and plots/migration_effect.png")