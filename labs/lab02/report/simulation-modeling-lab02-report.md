...
Смотрю графиками ([рис. @fig-006]).

![Каталог с графиками](image/006.png){#fig-006 width=70%}

Смотрю qmd файл ([рис. @fig-007]).

![qmd файл](image/007.png){#fig-007 width=70%}

Смотрю jupyter-notebook и запустим все ячейки ([рис. @fig-008]).

![Выполнение Jupyter-ноутбука](image/008.png){#fig-008 width=70%}

### Модель Лотки–Вольтерры

Создаю файл scripts/lv_ode.jl с реализацией модели ([рис. @fig-009]).
